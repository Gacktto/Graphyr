  ...
  return (
    <div className={styles.sidebar} style={{ left: 0 }}>
      <div className={styles.menu} style={{ borderRight: "1px solid #3c3c3c" }}>
        ...
        <div className={styles.section} style={{ padding: "0 12px", overflowY: "auto", maxHeight: "calc(100vh - 160px)" }}>
          <TreeView elements={elements} selectedId={selectedId} onSelect={setSelectedId} />
        </div>
      </div>
